...
class Exame(models.Model):
    ...
    profissional_solicitante = models.ForeignKey(Profissional, on_delete=models.SET_NULL, null=True, related_name='exames_solicitados', verbose_name='Profissional Solicitante')
    ...
    resultados = models.TextField(verbose_name='Resultados do Exame', blank=True, null=True)
    documento_resultado = models.ForeignKey(DocumentoAssinado, on_delete=models.SET_NULL, blank=True, null=True, related_name='exames_resultados', verbose_name='Documento do Resultado')
    observacoes = models.TextField(verbose_name='Observações', blank=True, null=True)
    status = models.CharField(max_length=20, choices=[('Solicitado', 'Solicitado'), ('Realizado', 'Realizado'), ('Cancelado', 'Cancelado')], default='Solicitado')
